		...
		<>
			<MenuContainer>
				<ButtonContainerWrapper>
					<ButtonsContainer>
						<View
							style={{ overflow: 'hidden', borderRadius: 25, width: '100%' }}
						>
							<ButtonTouchable
								onPressOut={() => {
								...
								onPressIn={() => setButtonStyle({ ...buttonStyle, 1: true })}
								style={
									buttonStyle['1'] ? styles.activePress : styles.casualPress
								}
							>
								<ButtonName
									style={{ letterSpacing: 4 }}
									style={
										buttonStyle['1'] ? styles.activeText : styles.casualText
									}
								>
									My profile
								</ButtonName>
							...
							<ButtonTouchable
								...
								onPressIn={() => setButtonStyle({ ...buttonStyle, 2: true })}
								style={
									buttonStyle['2'] ? styles.activePress : styles.casualPress
								}
							>
								<ButtonName
									style={{ letterSpacing: 4 }}
									style={
										buttonStyle['2'] ? styles.activeText : styles.casualText
									}
								>
									Learning
								</ButtonName>
							...
							<ButtonTouchable
								...
								onPressIn={() => setButtonStyle({ ...buttonStyle, 4: true })}
								style={
									buttonStyle['4'] ? styles.activePress : styles.casualPress
								}
							>
								<ButtonName
									style={{ letterSpacing: 4 }}
									style={
										buttonStyle['4'] ? styles.activeText : styles.casualText
									}
								>
									About App
								</ButtonName>
							...
							<ButtonTouchable
								onPressOut={() => setButtonStyle({ ...buttonStyle, 5: false })}
								onPressIn={() => setButtonStyle({ ...buttonStyle, 5: true })}
								style={
									buttonStyle['5'] ? styles.activePress : styles.casualPress
								}
							>
								<ButtonName
									style={{ letterSpacing: 4 }}
							...
							<ButtonTouchable
								...
								style={
									buttonStyle['7']
										...
										: { ...styles.casualPress, borderBottomWidth: 0 }
								}
							>
								<ButtonName
									style={{ letterSpacing: 4 }}
				...
				<FooterContainer>
					<FooterButtonTouch>
						<FooterButtonName>download</FooterButtonName>
					</FooterButtonTouch>
					<FooterImageWrapper>
