...
const LearningChooseLvlScreen = ({navigation}) => {
    ...
    return (
        <Stack.Navigator initialRouteName="LChoose">
            <Stack.Screen name='LChoose' component={LChooseScreen} options={{
                headerShown: false
            }} />
        </Stack.Navigator>
    )
            ...
            <LCContainer>
                <LvlRow>
                    <LvlButton 
                        ...
                        style={ buttonStyle["1"] ? {backgroundColor: 'white'} : {backgroundColor: '#BBCAFE'}} >
                ...
                <LvlRow>
                    <LvlButton
                        ...
                        style={ buttonStyle["2"] ? {backgroundColor: 'white'} : {backgroundColor: '#D8FFCB'}} >
                ...
                <LvlRow>
                    <LvlButton
                        ...
                        style={ buttonStyle["3"] ? {backgroundColor: 'white'} : {backgroundColor: '#FFFDCB'}}
                        >
                ...
                <LvlRow>
                    <LvlButton
                        ...
                        style={ buttonStyle["4"] ? {backgroundColor: 'white'} : {backgroundColor: '#FEBBEB'}}
                    >
                ...
                <LvlRow>
                    <LvlButton 
                        ...
                        style={ buttonStyle["5"] ? {backgroundColor: 'white'} : {backgroundColor: '#E890FF'}}
                    >
                ...
                <LvlRow>
                    <LvlButton
                        ...
                        style={ buttonStyle["6"] ? {backgroundColor: 'white'} : {backgroundColor: '#E6FFFF'}}
                    >
